  ...
  return (
    <div className={classes.product}>
      ...
      <div className={classes.productBody}>
        ...
        <div className={classes.productRatingCtn}>{productRating()}</div>
      </div>
      <div className={classes.wishListAndQuickViewBtn}>
        <button className={classes.addToWishList}>
          {" "}
          <span className={classes.addToWishListAndQuickViewText}>add to wishlist</span>
        </button>
        <button className={classes.quickViewBtn}>
          <span className={classes.addToWishListAndQuickViewText}>quick view</span>
        </button>
      </div>
